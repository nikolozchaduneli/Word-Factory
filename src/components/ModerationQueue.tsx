  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        {flags.length === 0 ? (
          <p className="text-sm au-text-muted">No open flags.</p>
        ) : (
            ...
            {flags.map((flag) => (
              ...
              >
                <div>
                  ...
                  <span className="ml-2 rounded px-1.5 py-0.5 text-xs au-status-rejected">
                    {flag.reason}
                  </span>
                  {flag.description && (
                    <p className="text-xs au-text-muted mt-1">
                      {flag.description}
                    </p>
                  )}
                  <p className="text-xs au-text-muted mt-1">
                ...
                <div className="flex gap-1">
                  ...
                  <button
                    ...
                    disabled={loading === flag.id}
                    className="au-btn-ghost rounded px-2.5 py-1 text-xs font-medium"
                  >
                    Dismiss
                  </button>
                </div>
      ...
      <section>
        ...
        {pendingWords.length === 0 ? (
          <p className="text-sm au-text-muted">No pending submissions.</p>
        ) : (
          <div className="space-y-2">
            {pendingWords.map((word) => (
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm au-text-muted truncate">
                    {word.definition}
                  </p>
                  <p className="text-xs au-text-muted">
      ...
      <section>
        ...
        {pendingSuggestions.length === 0 ? (
          <p className="text-sm au-text-muted">No pending suggestions.</p>
        ) : (
          <div className="space-y-2">
